...
class GamingLaptop(HomePage):

    def __init__(self, driver):
        self.locator = LoginLocators
        self.driver = driver
        super(GamingLaptop, self).__init__(driver)
    ...
    def category_arrow(self):
        time.sleep(4)
        self.find_element(*self.locator.category_arrow).click()

    def gaming_laptop(self):
        time.sleep(4)
